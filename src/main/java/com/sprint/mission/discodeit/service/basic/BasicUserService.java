...
public class BasicUserService implements UserService {
    ...
    public UserDto create(UserCreateRequest userCreateRequest,
        ...
        log.debug("사용자 생성 시작: username={}, email={}", userCreateRequest.username(), userCreateRequest.email());
        ...
        log.info("사용자 생성 성공: id={}, username={}, email={}", user.getId(), username, email);
